...
| ------------------- | -------------------- | ------------------------------------------------------------------- | ------------------- | ----------- |
| `containerSelector` | `container-selector` | Optional selector to attach parent key events. Defaults to document | `string`            | `undefined` |
...
| `width`             | `width`              | Custom width style, as a string including units                     | `string`            | `undefined` |
